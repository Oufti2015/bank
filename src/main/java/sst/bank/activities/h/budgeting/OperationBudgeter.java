...
public class OperationBudgeter implements BankActivity {
    ...
    public void run() {
        ...
        Budget spendingBudget = new Budget();
        if (optcat.isPresent()) {
        ...
        BigDecimal subtractAmount = spendingBudget.monthlyAmount().subtract(spendingControlledAmountBudget, MathContext.DECIMAL64);
    ...
    private void printDebugInfo(List<Budget> budgets) {
        log.debug(OuftiBank.MESSAGE_LINE_STRING);
